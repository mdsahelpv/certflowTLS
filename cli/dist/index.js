...
userCommand
    ...
    try {
        ...
        if (options.page)
            params.append('page', options.page);
        const response = await axios_1.default.get(`${server}/api/users`, {
            params,
            headers: { Authorization: `Bearer ${token}` },
        });
        if (response.status === 200) {
...
userCommand
    ...
    try {
        const response = await axios_1.default.post(`${server}/api/users/create`, {
            username: options.username,
            email: options.email,
            password: options.password,
            role: options.role,
...
userCommand
    ...
    try {
        ...
        const response = await axios_1.default.post(`${server}/api/users/update`, payload, {
            headers: { Authorization: `Bearer ${token}` },
        });
        if (response.status === 200) {
...
userCommand
    ...
    try {
        const response = await axios_1.default.post(`${server}/api/users/delete`, { id: options.id }, {
            headers: { Authorization: `Bearer ${token}` },
        });
        if (response.status === 200) {
...
userCommand
    ...
    try {
        const response = await axios_1.default.post(`${server}/api/users/reset-password`, { id: options.id }, {
            headers: { Authorization: `Bearer ${token}` },
        });
        if (response.status === 200) {
...
auditCommand
    ...
    try {
        ...
        const response = await axios_1.default.get(`${server}/api/audit`, {
            params,
            headers: { Authorization: `Bearer ${token}` },
        });
        if (response.status === 200) {
...
auditCommand
    ...
    try {
        ...
        const response = await axios_1.default.get(`${server}/api/audit/export`, {
            params,
            headers: { Authorization: `Bearer ${token}` },
